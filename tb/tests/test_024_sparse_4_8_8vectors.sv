`ifndef TEST_024_SPARSE_4_8_8VECTORS_SV
`define TEST_024_SPARSE_4_8_8VECTORS_SV


class test_024_sparse_4_8_8vectors extends base_test;

  `uvm_component_utils(test_024_sparse_4_8_8vectors)
  
  function new(string inst = "test_024_sparse_4_8_8vectors", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_024 : Sparse 4:8 - 8 Vectors - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 8, "Test_024 : Sparse 4:8 - 8 Vectors");
    
    $display("===================================================Test_024 : End of the test=================================================================");
