`ifndef TEST_020_SPARSE_2_4_8VECTORS_SV
`define TEST_020_SPARSE_2_4_8VECTORS_SV


class test_020_sparse_2_4_8vectors extends functionality_basetest;

  `uvm_component_utils(test_020_sparse_2_4_8vectors)
  
  function new(string inst = "test_020_sparse_2_4_8vectors", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_020 : Sparse 2:4 - 8 Vectors - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 8, "Test_020 : Sparse 2:4 - 8 Vectors");
    
    $display("===================================================Test_020 : End of the test=================================================================");
