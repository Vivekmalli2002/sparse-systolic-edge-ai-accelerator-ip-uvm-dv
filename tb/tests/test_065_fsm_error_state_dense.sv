`ifndef TEST_065_FSM_ERROR_STATE_DENSE_SV
`define TEST_065_FSM_ERROR_STATE_DENSE_SV

class test_065_fsm_error_state_dense extends base_test;
  `uvm_component_utils(test_065_fsm_error_state_dense)

  function new(string name = "test_065_fsm_error_state_dense", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("=================================Test_065 : FSM Error State (Abort Injection) - Start============================================");
    ...
    $display("===================================================Test_065 : End of the test=================================================================");
