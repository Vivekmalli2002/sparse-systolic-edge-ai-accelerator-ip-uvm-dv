`ifndef TEST_016_SPARSE_1_4_SV
`define TEST_016_SPARSE_1_4_SV


class test_016_sparse_1_4 extends functionality_basetest;

  `uvm_component_utils(test_016_sparse_1_4)
  
  function new(string inst = "test_016_sparse_1_4", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_016 : Sparse 1:4 - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 1, "Test_016 : Sparse 1:4");
    
    $display("===================================================Test_016 : End of the test=================================================================");
