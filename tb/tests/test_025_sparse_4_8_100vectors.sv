`ifndef TEST_025_SPARSE_4_8_100VECTORS_SV
`define TEST_025_SPARSE_4_8_100VECTORS_SV


class test_025_sparse_4_8_100vectors extends functionality_basetest;

  `uvm_component_utils(test_025_sparse_4_8_100vectors)
  
  function new(string inst = "test_025_sparse_4_8_100vectors", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    w_tile_tnx.sparsity_mode = SPARSITY_4_8;
    ...
    $display("===================================================Test_025 : Sparse 4:8 - 100 Vectors - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 100, "Test_025 : Sparse 4:8 - 100 Vectors");
    
    $display("===================================================Test_025 : End of the test=================================================================");
