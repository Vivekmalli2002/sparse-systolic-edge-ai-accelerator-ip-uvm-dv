`ifndef TEST_015_SPARSE_2_4_SV
`define TEST_015_SPARSE_2_4_SV


class test_015_sparse_2_4 extends functionality_basetest;

  `uvm_component_utils(test_015_sparse_2_4)
  
  function new(string inst = "test_015_sparse_2_4", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_015 : Sparse 2:4 - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 1, "Test_015 : Sparse 2:4");
    
    $display("===================================================Test_015 : End of the test=================================================================");
