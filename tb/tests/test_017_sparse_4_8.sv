...
class test_017_sparse_4_8 extends base_test;
  ...
  function new(string inst = "test_017_sparse_4_8", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_017 : Sparse 4:8 - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 1, "Test_017 : Sparse 4:8");
    
    $display("===================================================Test_017 : End of the test=================================================================");
