`ifndef TEST_018_DENSE_32VECTORS_SV
...
class test_018_dense_32vectors extends functionality_basetest;
  ...
  function new(string inst = "test_018_dense_32vectors", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_018 : Dense 32 Vectors - Start=================================================================");
    
    //call run_compute_test
    run_compute_test(w_tile_tnx, a_stream_tnx,32'h0000_0001,32, "Test_018 : Dense 32 Vectors");
    
    $display("===================================================Test_018 : End of the test=================================================================");
