`ifndef TEST_019_DENSE_100VECTORS_SV
...
class test_019_dense_100vectors extends functionality_basetest;
  ...
  function new(string inst = "test_019_dense_100vectors", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_019 : Dense 100 Vectors - Start=================================================================");
    
    //call run_compute_test
    run_compute_test(w_tile_tnx, a_stream_tnx,32'h0000_0001,100, "Test_019 : Dense 100 Vectors");
    
    $display("===================================================Test_019 : End of the test=================================================================");
