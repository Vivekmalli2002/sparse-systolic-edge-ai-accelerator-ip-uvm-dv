...
class axil_csr_drv extends uvm_driver #(axil_csr_tnx);
  ...
  task do_write();
    ...
    @(posedge vif.clk iff vif.drv_cp.awready);
    vif.drv_cp.awvalid <= 0;
    ...
    vif.drv_cp.wvalid <= 1;
    @(posedge vif.clk iff vif.drv_cp.wready);
    vif.drv_cp.wvalid <= 0;
    ...
    @(vif.drv_cp);
    vif.drv_cp.bready <= 1;
    @(posedge vif.clk iff vif.drv_cp.bvalid);
  ...
  task do_read();
    ...
    @(posedge vif.clk iff vif.drv_cp.arready);
    vif.drv_cp.arvalid <= 0;
    ...
    @(posedge vif.clk iff vif.drv_cp.rvalid);
