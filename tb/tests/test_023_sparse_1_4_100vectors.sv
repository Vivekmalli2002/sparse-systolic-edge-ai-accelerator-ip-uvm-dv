`ifndef TEST_023_SPARSE_1_4_100VECTORS_SV
...
class test_023_sparse_1_4_100vectors extends base_test;
  ...
  function new(string inst = "test_023_sparse_1_4_100vectors", uvm_component parent = null);
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    $display("===================================================Test_023 : Sparse 1:4 - 100 Vectors - Start=================================================================");
    
    run_compute_test(w_tile_tnx, a_stream_tnx, 32'h0000_0002, 100, "Test_023 : Sparse 1:4 - 100 Vectors");
    
    $display("===================================================Test_023 : End of the test=================================================================");
